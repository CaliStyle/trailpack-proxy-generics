...
module.exports = {
  /**
   * configure - Configure the Proxy Generics
   * @param app
   */
  configure: (app) => {
    ...
    // Bind the Methods
    Object.assign(app.generics, trailsCore.bindMethods(app, 'generics'))
    return
  },
  /**
   * Add Generics APIs
   ...
   */
  addRoutes: (app) => {
    const prefix = _.get(app.config, 'proxyGenerics.prefix') || _.get(app.config, 'footprints.prefix')
